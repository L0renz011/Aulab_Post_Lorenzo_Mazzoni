    ...
    public function store(Request $request)
         ...
         */
            ...
            */
            ...
            return redirect('writer.dashboard')->with('message', 'Hai aggiornato correttamente l\'articolo');
        ...
        public function destroy(Article $article)
            {
                ...
                return redirect(route('writer.dashboard'))->with('message', 'Hai cancellato correttamente l\'articolo scelto');
            }
